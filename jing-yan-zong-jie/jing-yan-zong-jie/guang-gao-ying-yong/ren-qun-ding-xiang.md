...
1. 开发同学疯狂加班，但效果就是不好
2. 广告主使用十分困惑，人群定向\(兴趣/行业\)功能性价比极低
...
1. 可以看到，基于当前体系类别的界定，同级下卡牌类和棋类这两类别人群量级差了10倍以上，算法同学都知道，分布差的话，需要付出多大的努力才能效果。简单理解，如果同级下有两类，两类分布比为99:1。那还用什么算法，来100个人，我都归到第一类，准确率99%！（当然，这里字节的同学肯定用多标签或二分类做的，我只是举个易理解例子）

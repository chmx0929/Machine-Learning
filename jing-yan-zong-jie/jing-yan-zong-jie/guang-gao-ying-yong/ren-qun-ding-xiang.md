...
最近负责广告人群定向\(兴趣/行业\)体系的重构，写本篇记录工作。人群兴趣标签可以说是用户画像中最重要的一环，既可直接商业化又能作为基础特征数据输入后续算法。**但用于商业化的人群兴趣标签和UGC\(用户原创内容\)标签的差别比较大，比如同样是汽车兴趣标签，对于自然\(UGC\)来说挖掘出对汽车感兴趣的人即可，但对于商业标签，需要挖掘出要对车感兴趣且有买车计划的人群。**且商业标签是给广告主用的，都是与广告商业价值强相关的类别，广告主进行选择的时候不需要过多思考即知道哪个标签是为自己广告计划量身定做的，追求的是提升广告效果。总的来说蛮有趣的，很值得去深入探讨和挖掘

## 体系框架

大部分同学都是等产品将标签体系框架定下来，然后进行人群定向的工作。这是一个很不健康的做法，要参与体系框架的制定，甚至大部分时间都要在这一部分。如果体系制定的不好，会造成两个后果：
...
再让我们回到一开始说的游戏标签，猜测一下巨量明知不合理，但为什么还这么做呢？对于商业标签来说最最重要的一个原则：**听金主的**。下图是3dm game的分类，可以代表一般人认知了。巨量在此基础上加了消除、跑酷、棋类，可能是这几个类有大的广告主来，故而又开发出这几类。所以用于广告的兴趣标签画像体系，合理只是基础原则，根本还是给广告主服务。但个人建议，像这种额外加的标签，只曝光给对应广告主即可，全部广告主都能看到容易造成误解歧义。

![](../../../.gitbook/assets/wang-you-3dm.png)

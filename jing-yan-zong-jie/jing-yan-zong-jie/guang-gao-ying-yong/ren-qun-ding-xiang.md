...
所以，一个好的体系十分重要。那什么算是好的合理的体系呢？经调研和分析，需要满足两点：1、父子类高关联；2、同级类区分明显。我基于图谱构建经验制定了指标：

* 父子类高关联： $$p(A|B)*p(B|A)$$ ，其中，A为父类，B为子类，条件概率乘积越高关联越高。就可以解决
...
原则定下来后，再往下做就比较简单了，但是还有一些小trick，比如教育培训-兴趣培训-绘画、书法、陶艺、乐器、表演、跆拳道、游泳、烹饪、编程...分类过细人群会很少不利于投放，全都合并到教育培训-兴趣培训级别人群又会过多。

...
我们的做法借鉴了巨量，在兴趣培训二级下设置体育与运动、声乐与乐器、科技与编程、美术/书法与手工艺、舞蹈与表演几个三级，若某一类人群依旧过多，可以拆分成四级，为自己留后路，做到以后尽量少的调整。

![&#x5DE8;&#x91CF;&#x5174;&#x8DA3;&#x5B9A;&#x5411;&#x793A;&#x4F8B;](../../../.gitbook/assets/ju-liang-xing-qu-ding-xiang.png)

当然这种主观的体系设置，每个人理解总会有偏差，比如基础教育，有人理解为学前教育，有人理解为中小学教育，有人理解为面向全年龄的各种科普...所以像上图巨量的示例展示关键词是十分必要的，但巨量采用了比较naive的方法，经分析其相关词仅是分词了广告内容作为相关词，会造成不同类别相关词重合大，意义模糊，毕竟一个广告主一个广告可能针对多个兴趣类别。我们的做法是爬取竞品关键词，结合微博高频词，也从其他信息源爬取了部分词，人工标注了20至50个具有区分度词帮助广告主理解释义。
